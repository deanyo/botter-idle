...
const _STAT_DESCRIPTIONS := {
	# Base item stats (rendered at the top of the tooltip).
	...
	"str": "Each excess STR (over 5): +1.5% max HP, +melee damage scaling.",
	"dex": "Each excess DEX (over 5): +0.5% crit, +1% haste.",
	"int": "Each excess INT (over 5): +1% spell damage, +0.5% area, +0.5% duration.",
	...
	"fire_extra": "Adds X-Y fire damage to each hit.",
	"cold_extra": "Adds X-Y cold damage to each hit.",
	"thunderous_extra": "Adds X-Y lightning damage to each hit.",
	"lightning_extra": "Adds X-Y lightning damage to each hit.",
	"holy_extra": "Adds X-Y holy damage to each hit.",
	"poison_extra": "Adds X-Y poison damage to each hit.",
	"dark_extra": "Adds X-Y dark damage to each hit.",
	"physical_extra": "Adds X-Y physical damage to each hit.",
	# Resistances.
	...
	"sage_per_unspent_pct": "+(N × min(unspent, 10) / 10)% spell damage. Caps at 24% with 10 unspent.",
